...
<head>
<meta charset="UTF-8">
<title>Fattener Profiles <?= $batch ? '- ' . htmlspecialchars($batch['batch_no']) : '' ?></title>
...
<div class="sidebar">
    ...
    <a href="#" class="active"><i class="fa-solid fa-users"></i> Fattener Profiles</a>
...
<!-- TOPBAR -->
<div class="topbar">
    <h5 class="m-0"><i class="fa-solid fa-users"></i> Fattener Profiles <?= $batch ? '- ' . htmlspecialchars($batch['batch_no']) : '' ?></h5>
...
<div class="content">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="fw-bold mb-0">Fattener Profiles <?= $batch ? '- ' . htmlspecialchars($batch['batch_no']) : '' ?></h4>
